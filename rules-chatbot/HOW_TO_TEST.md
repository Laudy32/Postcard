...
### Steps
1. Open this link: **`https://laudy32.github.io/Postcard/`**
...
`rules-chatbot/web/README.md` — that path needs a Terminal command and is
...
instructions are in `rules-chatbot/kiosk/README.md`, including setting the
